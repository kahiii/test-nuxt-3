...
class WebpackBundler {
  ...
  async build() {
    ...
    if (styleResources && Object.keys(styleResources).length) {
      logger.warn("Using styleResources without the @nuxtjs/style-resources is not suggested and can lead to severe performance issues.", "Please use https://github.com/nuxt-community/style-resources-module");

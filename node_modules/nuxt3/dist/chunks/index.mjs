...
import { resolveFiles, useNuxt, defineNuxtModule, addPlugin, addVitePlugin, addWebpackPlugin, addTemplate, isNuxt3, resolveAlias, addPluginTemplate, logger, nuxtCtx, addComponent, installModule, loadNuxtConfig, templateUtils, normalizeTemplate, compileTemplate, findPath, normalizePlugin } from '@nuxt/kit';
  ...
  return {
    ...
    transform(code, id) {
      ...
      if (!parseQuery(search).macro) {
        return originalCode === code ? void 0 : code;
      }

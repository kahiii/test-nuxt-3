...
import { a as relative, j as join, i as isAbsolute, r as resolve } from './index2.mjs';
...
const writeTypes = async (nuxt) => {
  ...
  for (const alias in aliases) {
    ...
    const relativePath = isAbsolute(aliases[alias]) ? relative(nuxt.options.rootDir, aliases[alias]).replace(/(?<=\w)\.\w+$/g, "") || "." : aliases[alias];
